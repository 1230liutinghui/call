<template>
  <el-row>
    <el-row>
      <div style="text-align: center;font-size: 24px;margin-top: 10vh">
        请配置您的电话号码
      </div>
      </el-row>
    <div class="user-login">
      <el-input placeholder="请配置您的电话号码" v-model="UserID" maxlength="11" class="phone-num"></el-input>
      <el-button class="user-login-btn" @click="handleLogin">确定</el-button>
    </div>
  </el-row>
</template>
