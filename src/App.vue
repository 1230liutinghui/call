<template>
  <div id="app">
    ...
    <el-dialog :title="语音通话" :visible.sync="isShowNewInvitationDialog" width="400px">
      <span style="font-size: 18px">{{this.getNewInvitationDialogContent()}}</span>
      <span slot="footer" class="dialog-footer" style="text-align: center">
        <el-button @click="handleRejectCall" style="background: #f56c6c;color: #FFFFFF">拒绝</el-button>
  ...
  methods: {
    ...
    handleAcceptCall: async function() {
      try {
        ...
        // const localStreamAsrfar = new ASR({
        ...
        //   convert_num_mode : 1,
        //   word_info: 2,
        //   audioTrack: this.$trtcCalling._trtcClient._remoteStreams.getAudioTrack() // this.localStream_.getAudioTrack() 为获取的本地流的音轨
        // })
       ...
       // 一句话开始
        ...
        // localStreamAsrfar.start();
        // // 开始识别
        // localStreamAsrfar.OnRecognitionStart = (res) => {
        //   console.log('本地流：开始识别', res);
        // };
        // // 一句话开始
        // localStreamAsrfar.OnSentenceBegin = (res) => {
        //   console.log('本地流：一句话开始', res);
        // };
        // // 识别变化时
        // localStreamAsrfar.OnRecognitionResultChange = (res) => {
        //   console.log('本地流：识别变化时', res);
        // };
        // // 一句话结束
        // localStreamAsrfar.OnSentenceEnd = (res) => {
        //   console.log('本地流：一句话结束', res);
        // };
        // // 识别有结果时
        // localStreamAsrfar.OnChange = (res) => {
        //   console.log('本地流：识别中' ,res)}
        // initClient(state)
        // meetPerson.client
        //     .join({ roomId: roomID })
